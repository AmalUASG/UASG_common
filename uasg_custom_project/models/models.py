...
class UASGProject(models.Model):
    ...
    def action_submit(self):
        ...
        payload = str('response_mode=form_post&response_type=code&client_id=2e98a997-764b-41e6-976f-4451a215e063&scope=https%3A%2F%2Fgraph.microsoft.com%2F.default&redirect_uri=https%3A%2F%2Fapp.uasg.ae%2Fauth_oauth%2Fsignin')
        # url = str("https://login.microsoftonline.com/58481125-7f09-407d-921a-dc425b00fd0f/oauth2/v2.0/authorize") 
        req = requests.request("GET" , url='https://app.uasg.ae/microsoft_account/authentication',headers=headers,data=payload)
        # req = req.json()
