...
#         #     raise UserError(str(response))
    ...
    def action_pipeline(self):
        ...
        if self.assigned_to.manager_email == self.env.user.login :
            ...
            raise UserError('Sorry , Approval should be done by the Line Manager : ' + str(self.assigned_to.manager_name))
    ...
    def action_reopen(self):
        ...
        if self.assigned_to == self.env.user or self.self.assigned_to.manager_email == self.env.user.login :
    ...
    def action_draft(self):
        ...
        if self.assigned_to == self.env.user or self.assigned_to.manager_email == self.env.user.login :
